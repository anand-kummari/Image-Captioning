...
if __name__ == '__main__':
  ...
  # load the tokenizer
  tokenizer = load(open('/content/gdrive/My Drive/B.Tech Project/Image Captioning/models/tokenizer.pkl', 'rb'))
  index_word = load(open('/content/gdrive/My Drive/B.Tech Project/Image Captioning/models/index_word.pkl', 'rb'))
  ...
  if args.model:
    ...
    filename = '/content/gdrive/My Drive/B.Tech Project/Image Captioning/models/model_weight.h5'
  ...
  if args.image:
    ...
    #   print(desc)
      file = open('/content/gdrive/My Drive/B.Tech Project/Image Captioning/dog.txt','w')
      file.write(desc)
      file.close()
  else:
    # load test set
